...
class VGG(torch.nn.Module):
    ...
    def __init__(self, num_classes=10,depth=19, init_weights=True, batch_norm=True,cfg=None):
...
def vgg11(num_classes, **kwargs) -> VGG:
    """VGG 11-layer model
...
def vgg11_bn(num_classes,dataset='CIFAR10', **kwargs) -> VGG:
...
def vgg13(num_classes,dataset='CIFAR10', **kwargs) -> VGG:
    """VGG 13-layer model 
...
def vgg13_bn(num_classes,dataset='CIFAR10', **kwargs) -> VGG:
...
def vgg16(num_classes,dataset='CIFAR10', **kwargs) -> VGG:
    """VGG 16-layer model
...
def vgg16_bn(num_classes=10,dataset='CIFAR10', **kwargs) -> VGG:
...
def vgg19(num_classes,dataset='CIFAR100', **kwargs) -> VGG:
    """VGG 19-layer model 
...
def vgg19_bn(num_classes,dataset='CIFAR10', **kwargs) -> VGG:
